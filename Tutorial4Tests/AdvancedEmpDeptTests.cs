...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = emps.Select(emp=>emp).Where(emp=>emp.Mgr != null).ToList(); 
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps.Join(emps, emp1 => emp1.Mgr, emp2 => emp2.EmpNo, (emp1, emp2) => new { Employee=emp1.EName, Manager=emp2.EName});
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps
            ...
            .SelectMany(temp => grades, (temp, grade) => new {temp.EName, temp.DName, temp.Sal, grade.Grade, grade.Losal, grade.Hisal})
            .Where(final => final.Sal >= final.Losal && final.Sal <= final.Hisal)
            .Select(final => new {final.EName, final.DName, final.Grade})
            .ToList();
